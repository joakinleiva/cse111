...
def main():
    ...
    getting_compound_name = get_formula_name(formula, known_molecules_dict)
    if getting_compound_name != "Error! Unknown compound!":
        print(" ")
        print(f"You have chosen: {getting_compound_name}.")  
        print(" ")
    else:
      print(f"You have chosen: {formula}") 
